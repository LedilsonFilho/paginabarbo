...
class JwtAutenticador extends AbstractGuardAuthenticator
{
    ...
    //seta as rotas não protegidas
    public function supports(Request $request)
    {
        $home = $request->getPathInfo() == '/';
        $login = $request->getPathInfo() == '/login';
        $nova = $request->getPathInfo() == '/nova';
    ...
    public function getCredentials(Request $request)
    {
        ...
        try {
            return JWT::decode($token, 'B@r12bo16', ['HS256']);
        } catch (\Exception $e) {
            return false;
        }
    }
